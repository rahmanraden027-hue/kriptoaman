...
const statements = [
  ...
  'CREATE INDEX IF NOT EXISTS idx_kam_points_audit_snapshots_created ON kam_points_audit_snapshots(created_at DESC)',
  ...
  'CREATE INDEX IF NOT EXISTS idx_kam_points_audit_snapshot_entries_user ON kam_points_audit_snapshot_entries(user_id, snapshot_id)',
  ...
  'CREATE INDEX IF NOT EXISTS idx_kam_snapshot_approval_status ON kam_points_audit_snapshot_approvals(approval_status, updated_at DESC)',
];
