...
const ZEVARYQ_INDICATIVE_LISTING_REFERENCE = Object.freeze({
  value: 29.37,
  currency: 'USD',
...
export async function onRequestGet({ request }) {
  ...
  const base = {
    ...
    indicativeListingReference: ZEVARYQ_INDICATIVE_LISTING_REFERENCE,
  ...
  try {
    ...
    return json({
      ...
      blockNumber,
      wallet: address ? { address, balanceZVQ: formatZvq(walletBalance), balanceSymbol: 'ZVQ' } : null,
    ...
    return json({
      ...
      verified: false,
      blockNumber: null,
      wallet: address ? { address, balanceZVQ: null, balanceSymbol: 'ZVQ' } : null,
