...
export default function PWAInstallPrompt() {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center overflow-hidden rounded-2xl border border-sky-400/30 bg-sky-700 text-white shadow-2xl shadow-sky-950/50">
          <button
            type="button"
            onClick={install}
            className="flex min-h-12 items-center gap-2 px-4 py-3 text-sm font-bold hover:bg-sky-800"
          ...
          <button
            ...
            className="flex min-h-12 min-w-11 items-center justify-center border-l border-white/15 px-3 hover:bg-sky-800"
