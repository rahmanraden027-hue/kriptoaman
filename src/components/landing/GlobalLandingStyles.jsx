...
export default function GlobalLandingStyles() {
  return (
    <style>{`
      .ka-landing{
        --ka-bg1:#020711; --ka-bg2:#050B18; --ka-card:#091426; --ka-card2:#0B1B33;
        --ka-border:#173252; --ka-text:#F8FAFC; --ka-text2:#A7B2C4;
        --ka-blue:#087CF0; --ka-cyan:#00C8FF; --ka-gold:#F5B72E; --ka-green:#22C55E;
        --ka-radius:16px;
      ...
      .ka-landing.light{
        ...
        --ka-blue:#087CF0; --ka-cyan:#0EA5E9; --ka-gold:#D97706; --ka-green:#16A34A;
      }
      ...
      .ka-glow{box-shadow:0 0 30px rgba(8,124,240,0.15);}
      .ka-glow-cyan{box-shadow:0 0 60px rgba(0,200,255,0.22);}
      ...
      .ka-btn-primary:hover{filter:brightness(1.08);box-shadow:0 8px 24px rgba(8,124,240,0.35);}
      ...
      .ka-chip{background:rgba(8,124,240,0.10);border:1px solid rgba(8,124,240,0.30);color:var(--ka-cyan);border-radius:999px;}
