      ...
      <div className="max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-1">
            ...
            <p className="text-xs ka-text2 mt-2 leading-relaxed">Dioperasikan oleh PT Kripto Aman Indonesia · Republik Indonesia. Bukan bursa, kustodian, broker, atau penasihat investasi.</p>
            <div className="flex items-start gap-2 text-xs ka-text2 mt-3 leading-relaxed"><MapPin className="w-3.5 h-3.5 ka-blue shrink-0 mt-0.5" /><address className="not-italic"><span className="font-semibold ka-text">Corporate Office</span><br />Soho Capital – Podomoro City, 25th Floor, Unit 2508<br />Jl. Letjen S. Parman Kav. 28<br />Tanjung Duren Selatan, Grogol Petamburan<br />Jakarta Barat, DKI Jakarta 11470 · Indonesia</address></div>
        ...
        <div className="ka-card2 p-4 mt-8 flex items-start gap-3"><AlertTriangle className="w-4 h-4 ka-gold shrink-0 mt-0.5" /><p className="text-xs ka-text2 leading-relaxed">Informasi pasar, riset, status jaringan, dan analisis risiko disediakan untuk pemantauan, verifikasi, dan edukasi. KriptoAman tidak memberikan nasihat investasi serta tidak menjanjikan harga, keuntungan, likuiditas, listing, atau hasil investasi tertentu.</p></div>
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mt-6 pt-6 border-t" style={{ borderColor: 'var(--ka-border)' }}><p className="text-xs ka-text2">© 2026 KriptoAman · PT Kripto Aman Indonesia.</p><div className="flex flex-wrap justify-center gap-4 text-xs ka-text2"><Link to="/enterprise" className="hover:ka-blue">Enterprise</Link><Link to="/company" className="hover:ka-blue">Company Facts</Link><Link to="/founder" className="hover:ka-blue">Founder & CEO</Link><Link to="/research" className="hover:ka-blue">Research</Link><Link to="/LegalCorporateInformation" className="hover:ka-blue">Legal & Corporate</Link><Link to="/PrivacyPolicy" className="hover:ka-blue">Privasi</Link><Link to="/TermsOfService" className="hover:ka-blue">Syarat</Link><Link to="/Disclaimer" className="hover:ka-blue">Disclaimer</Link></div></div>
      </div>
    </footer>
  );
}
