...
const COLS = [
  ...
  { title: 'Perusahaan', links: [['Tentang Kami', '/AboutUs'], ['Company Facts', '/company'], ['Founder & CEO', '/founder'], ['Legal & Corporate', '/LegalCorporateInformation'], ['Edukasi', '/Edukasi'], ['Kontak', '/Contact'], ['Kebijakan Privasi', '/PrivacyPolicy']] },
      ...
      <div className="max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-1">
            ...
            <p className="text-xs ka-text2 mt-3 leading-relaxed">Platform informasi, pemantauan, edukasi, dan analisis risiko indikatif aset kripto.</p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mt-6 pt-6 border-t" style={{ borderColor: 'var(--ka-border)' }}><p className="text-[11px] ka-text2">© 2026 KriptoAman. Hak cipta dilindungi.</p><div className="flex flex-wrap justify-center gap-4 text-[11px] ka-text2"><Link to="/company" className="hover:ka-blue">Company Facts</Link><Link to="/founder" className="hover:ka-blue">Founder & CEO</Link><Link to="/LegalCorporateInformation" className="hover:ka-blue">Legal & Corporate</Link><Link to="/PrivacyPolicy" className="hover:ka-blue">Kebijakan Privasi</Link><Link to="/TermsOfService" className="hover:ka-blue">Syarat Penggunaan</Link><Link to="/Disclaimer" className="hover:ka-blue">Disclaimer</Link></div></div>
      </div>
    </footer>
  );
}
