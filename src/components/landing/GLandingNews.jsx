    ...
    <section id="berita" className="px-4 py-10 sm:px-6">
      <div className="mx-auto max-w-[1440px]">
        ...
        <a
          ...
          aria-label="Baca arsip transisi identitas KAM ke ZEVARYQ"
        >
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2 text-[11px] ka-text2">
                <span className="inline-flex items-center gap-1.5 rounded-full border border-sky-400/20 bg-sky-400/10 px-3 py-1 font-bold ka-cyan">
                  <Newspaper className="h-3.5 w-3.5" /> Arsip Identitas Lama
                </span>
              ...
              <h3 className="mt-4 max-w-4xl text-xl font-black leading-tight ka-text sm:text-3xl">
                Arsip KAM 2026 dan transisi identitas menuju ZEVARYQ Network
              </h3>
              <p className="mt-3 max-w-3xl text-sm leading-6 ka-text2 sm:text-base">
                Publikasi ini dipertahankan sebagai catatan historis. Identitas jaringan aktif sekarang adalah ZEVARYQ Network dengan native asset ZVQ dan Chain ID 22028.
              </p>

              <span className="mt-5 inline-flex items-center gap-2 text-sm font-black ka-cyan">
                Baca arsip dan konteks migrasi <ArrowRight className="h-4 w-4 transition group-hover:translate-x-1" />
              </span>
            </div>

            <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
              <p className="text-[10px] font-black uppercase tracking-[0.18em] ka-text2">Legacy record</p>
