...
function contextualResults(query, language) {
  ...
  if (/^(kam|kam network|mainnet kam)$/i.test(q)) results.push({ id: 'network-kam-query', path: '/KAMNetwork', icon: Network, idLabel: 'ZEVARYQ Network', enLabel: 'ZEVARYQ Network', keywords: q });
