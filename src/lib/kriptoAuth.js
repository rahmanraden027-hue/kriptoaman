...
export const kriptoAuth = {
  ...
  async getAdminUserDirectory(limit = 200) { return request(`/api/auth/admin/users?limit=${encodeURIComponent(limit)}`); },
  async getAdminUsers(limit = 200) { const data = await this.getAdminUserDirectory(limit); return data.users || []; },
