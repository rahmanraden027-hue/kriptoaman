...
const PAGE_NAMES = [
  ...
  'Founder', 'Home', 'IntelligenceHub', 'KAM', 'KAMDeveloper', 'KAMGlobalRoadmap', 'KAMIncidentResponse', 'KAMLaunchReadiness', 'KAMNetwork', 'KAMNetworkDocs', 'KYC', 'KYCVerificationPage', 'LandingPage', 'Market', 'MarketResearch',
