          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-400 sm:text-base">
                KAMFactory, KAMRouter, dan WKAM telah dicocokkan secara reproducible dengan runtime bytecode di ZEVARYQ Mainnet. Pool dan likuiditas tetap dinonaktifkan sampai independent contract review, provenance counter-asset, dan otorisasi treasury selesai.
              </p>
            </div>
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-2">
          ...
          <section className="rounded-[26px] border border-slate-800 bg-slate-950/80 p-5 sm:p-6">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              {[
                ['Contract deployment', 'Completed on ZEVARYQ Mainnet'],
