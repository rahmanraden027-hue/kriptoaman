  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 pb-24">
      <div className="max-w-lg mx-auto px-4 pt-4">
        ...
        {/* Tab Nav */}
        <div className="grid grid-cols-4 gap-1 bg-slate-800/60 border border-slate-700/40 rounded-2xl p-1 mb-5">
          {TABS.map(tab => {
            const Icon = tab.icon;
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center gap-1 py-2.5 px-1 rounded-xl transition-all ${
                  isActive ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'text-slate-500 hover:text-slate-300'
                }`}
              >
