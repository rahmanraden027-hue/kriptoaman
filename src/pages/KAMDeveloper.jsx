...
const NETWORK = {
  name: 'ZEVARYQ Mainnet Candidate',
  chainId: 22028,
  chainIdHex: '0x560c',
  symbol: 'ZVQ',
  decimals: 18,
...
export default function KAMDeveloper() {
  ...
  const addToWallet = async () => {
    ...
    try {
      ...
      setWalletMessage('ZEVARYQ Network berhasil ditambahkan atau dikonfirmasi di wallet.');
    } catch (error) {
      ...
      <div className="mx-auto max-w-7xl space-y-5">
          ...
          <div className="relative z-10 grid gap-8 lg:grid-cols-[1.2fr_.8fr] lg:items-end">
            <div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="ka-command-kicker">ZEVARYQ DEVELOPER CONSOLE</p>
        ...
        <section className="grid gap-5 xl:grid-cols-[1.15fr_.85fr]">
          ...
          <div className="ka-command-panel p-5 sm:p-6">
            ...
            <h2 className="mt-1 text-xl font-black">Connect to ZEVARYQ</h2>
            ...
            <button onClick={addToWallet} className="mt-5 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl bg-sky-600 px-5 text-sm font-black text-white transition hover:bg-sky-500"><WalletCards className="h-4 w-4" /> Add ZEVARYQ Network</button>
            ...
            <a href={NETWORK.explorer} target="_blank" rel="noreferrer" className="mt-3 inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-2xl border border-emerald-400/20 bg-emerald-400/10 px-5 text-xs font-black text-emerald-200"><ExternalLink className="h-4 w-4" /> Open ZEVARYQ Explorer</a>
