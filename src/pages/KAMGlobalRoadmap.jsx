...
const COPY = {
  id: {
    badge: 'ZEVARYQ GLOBAL CAMPAIGN ROADMAP 2026–2027',
    title: 'ZEVARYQ Global Campaign Roadmap 2026–2027',
    ...
    principleItems: [
      ...
      ['Utility Expansion', 'ZVQ berkembang melalui penggunaan jaringan, layanan, aplikasi, dan integrasi developer.'],
    ...
    scenarioPositioningBody: 'Referensi US$29.37 ditempatkan sebagai skenario strategis yang terhubung dengan kemajuan fundamental. Harga pasar aktual akan menggunakan data perdagangan dan likuiditas nyata saat pasar ZVQ aktif.',
    roadmapTitle: 'Roadmap Kampanye Terbaru ZEVARYQ',
    ...
    rows: [
      ...
      ['Utility', 'ZVQ aktif untuk biaya dan layanan jaringan', 'Transaksi nyata, aplikasi, integrasi, dokumentasi developer', 'Meningkatkan penggunaan dan kebutuhan utilitas.'],
    ...
    growthFocusBody: 'Infrastruktur, utilitas, akses, likuiditas, adopsi, distribusi global, governance, dan market readiness bergerak sebagai satu kerangka penguatan fundamental ZVQ.',
    globalFramework: 'ZEVARYQ Global Growth Framework',
    globalFrameworkBody: 'KriptoAman menempatkan ZEVARYQ/ZVQ dalam kerangka pertumbuhan jangka panjang yang menggabungkan teknologi, utilitas, adopsi, likuiditas, tata kelola, dan ekspansi global.',
    pillars: [
    ...
    closing: 'ZEVARYQ dibangun untuk tumbuh bersama kekuatan jaringan, utilitas nyata, akses global, adopsi, dan ekosistem yang berkelanjutan.',
  ...
  en: {
    ...
    frameworkValue: 'Utility · Adoption · Liquidity · Global Access',
    direction: 'Executive Direction',
    directionBody: 'ZEVARYQ (ZVQ) is the native asset of ZEVARYQ Mainnet within the KriptoAman ecosystem with focus on infrastructure strength, network utility, global access, liquidity, adoption, and ecosystem growth. US$29.37 is used as an indicative scenario reference for understanding development direction based on fundamental milestones.',
    principles: 'Strategic Principles',
    principleItems: [
      ['Infrastructure Excellence', 'Strong network, distributed validators, secure RPC, explorer, backup, and observability.'],
      ['Utility Expansion', 'ZVQ grows through network usage, services, applications, and developer integrations.'],
    ...
    scenarioPositioning: 'Scenario Positioning',
    scenarioPositioningBody: 'US$29.37 is positioned as a strategic scenario connected to fundamental progress. Actual market price will use real trading and liquidity data when the ZVQ market becomes active.',
    roadmapTitle: 'Latest ZEVARYQ Campaign Roadmap',
    ...
    rows: [
      ...
      ['Utility', 'ZVQ active for network fees and services', 'Real transactions, applications, integrations, developer documentation', 'Expands usage and utility demand.'],
    ...
    growthFocus: 'Growth Focus',
    growthFocusBody: 'Infrastructure, utility, access, liquidity, adoption, global distribution, governance, and market readiness operate as one framework for strengthening ZVQ fundamentals.',
    globalFramework: 'ZEVARYQ Global Growth Framework',
    globalFrameworkBody: 'KriptoAman positions ZEVARYQ/ZVQ within a long-term growth framework combining technology, utility, adoption, liquidity, governance, and global expansion.',
    pillars: [
    ...
    closing: 'ZEVARYQ is built to grow with network strength, real utility, global access, adoption, and a sustainable ecosystem.',
  ...
  return (
    <div className="ka-bg min-h-screen pb-24 text-white">
      <main className="mx-auto max-w-6xl space-y-7 px-4 py-7 sm:px-6 lg:px-8">
        ...
        <section>
          <p className="ka-command-kicker">ZEVARYQ SCENARIO DRIVERS</p>
