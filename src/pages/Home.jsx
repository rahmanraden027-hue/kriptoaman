...
const COPY = {
  id: {
    ...
    heroBody: 'Pantau pasar, aset, risiko, dan keamanan dalam satu pusat kendali modern untuk keputusan yang lebih cepat dan terukur.',
  ...
  en: {
    ...
    heroEyebrow: 'GLOBAL CRYPTO INTELLIGENCE',
    heroTitle: 'KriptoAman Intelligence Workspace',
    heroBody: 'Monitor markets, assets, risk, and security in one modern command center for faster, more measured decisions.',
