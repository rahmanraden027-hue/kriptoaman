...
const NETWORK = {
  ...
  chainName: 'ZEVARYQ Mainnet Candidate',
      ...
      <div className="mx-auto max-w-5xl space-y-5">
        <section className="ka-command-hero overflow-hidden p-6 sm:p-8">
          ...
          <div className="mt-6 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl">
              <p className="ka-command-kicker">ZEVARYQ NETWORK · TRANSACTION LAB</p>
        ...
        <section className="grid gap-5 lg:grid-cols-[1.15fr_.85fr]">
          <div className="ka-command-panel p-5 sm:p-6">
            ...
            <p className="mt-2 text-sm text-slate-500">Batas keamanan percobaan: maksimal {MAX_TRIAL_KAM} ZVQ. Biaya jaringan ditampilkan dan dikonfirmasi oleh wallet.</p>
