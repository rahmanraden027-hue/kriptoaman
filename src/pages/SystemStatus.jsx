...
const FALLBACK_SERVICES = [
  ...
  { id: 'zevaryq', name: 'ZEVARYQ Mainnet RPC', critical: true, state: 'unknown' },
];
  ...
  const run = async () => {
    ...
    try {
      ...
      const platformServices = [
        ...
        {
          id: 'platform-zevaryq',
          name: components.zevaryq?.blockNumber != null ? `ZEVARYQ Mainnet RPC · block ${Number(components.zevaryq.blockNumber).toLocaleString(locale)}` : 'ZEVARYQ Mainnet RPC',
          critical: true,
          state: componentState(components.zevaryq?.status),
        },
      ];
