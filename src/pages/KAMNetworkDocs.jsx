      ...
      <div className="mx-auto max-w-4xl space-y-5">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card icon={WalletCards} title="Wallet metadata">
            ...
            <Link to="/KAMTokenomics" className="inline-flex items-center gap-1 font-semibold text-sky-300" >Historical KAM tokenomics v1 <ExternalLink className="h-3 w-3" /></Link>
          </Card>
