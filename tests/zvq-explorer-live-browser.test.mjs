...
test('live browser proof checks real populated indexed blocks and preserves approved visuals',()=>{
 for(const marker of ['playwright-core','#blocks a[href^="/block/"]','blue-gold-orbital-20260924','Chain ID 22028','.official-emblem','rainbowDataStatus','android-390','desktop-1440'])assert.ok(script.includes(marker),marker);
